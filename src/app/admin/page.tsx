                  ...
                  <tr key={t.id} className="hover:bg-surface2 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <EditTenant tenant={{ id: t.id, name: t.name, email: t.email, status: t.status, plan: t.plan, feature_summary_forward: t.feature_summary_forward, feature_orders: t.feature_orders }} />
                        <ConfirmDelete
