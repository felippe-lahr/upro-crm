      ...
      <div className="w-full max-w-lg">
        ...
        <div className="space-y-5 rounded-2xl border border-[#1b222c] bg-[#131820] p-8">
          ...
          <div className="flex overflow-hidden rounded-xl border border-[#232c38]">
            <button onClick={() => setBilling('monthly')} className={`flex-1 py-2.5 text-sm font-medium transition-colors ${billing === 'monthly' ? 'bg-green-500 text-white' : 'bg-transparent text-[#9aa6b2] hover:text-white'}`}>
              Mensal
            </button>
            <button onClick={() => setBilling('annual')} className={`relative flex-1 py-2.5 text-sm font-medium transition-colors ${billing === 'annual' ? 'bg-green-500 text-white' : 'bg-transparent text-[#9aa6b2] hover:text-white'}`}>
              Anual
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <button onClick={handleValidateCoupon} disabled={checkingCoupon || !couponCode.trim()} className="rounded-lg border border-[#232c38] px-3 py-2 text-sm text-[#9aa6b2] transition-colors hover:border-green-500 hover:text-green-400 disabled:opacity-40">
          ...
          {loading && <div className="text-center text-sm text-[#9aa6b2]">Processando pagamento...</div>}
